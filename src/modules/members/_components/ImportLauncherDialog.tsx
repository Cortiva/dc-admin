...
import { downloadMemberImportTemplate } from "../memberTemplate";
import { parseMemberSheet } from "../memberSheetParser";
    ...
    const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            ...
            if (result.rows.length === 0) {
                toast.error("That sheet doesn't have any member rows in it");
                return;
            }
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Add many members at once from a spreadsheet.
                    </DialogDescription>
                </DialogHeader>
